...
- [How Is It Possible To USE YOUR TONGUE To See The World Again?](https://youtu.be/D1ehHIGzmPc)

- [Human echolocation lets blind man 'see'](https://youtu.be/WHYCs8xtzUI)

- [TED - 我们能为人类创造新感官吗？](https://youtu.be/4c1lqFXHvqI)
...
![image-20200812024617447](./image-20200812024617447.png)

其中参数一般并不会显式地在图上表达出来，一般来讲一条边就对应有一个参数，例如 $a_1^{(2)}$ 的计算方式为：$a_1^{(2)}=\theta_0+\theta_1{x_1}+\theta_2{x_2}+\theta_3{x_3}$，一般偏置项也会默认包含在模型中。
...
![image-20200812030129716](./image-20200812030129716.png)
