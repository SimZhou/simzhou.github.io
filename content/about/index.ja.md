...
こんにちは。広い世界の中であなたがこのブログにたどり着いてくれたことは、とても幸運な偶然のように感じます。

私は Simon です。技術が好きな人間で、このブログが少しでもあなたの役に立てばうれしいです。

### 私は……

- 夢見る人
- 技術オタク
- 名前を覚えることよりも、物事がどう機能し、どうつながっているかを理解するほうが好きな人間で、[ファインマン・テクニック](https://golden.com/wiki/Feynman_Technique)の実践者
- 音楽、ゲーム、ランニングが好き
...
- [x] 日々の記録を残すため
- [x] 自分自身を表現するため
- [x] 2020年、インターネットが情報過多の時代に入った中で、私もその情報爆発に少し貢献してみようと思ったため（冗談です）
- [x] 初心を忘れないよう、自分に言い聞かせるため (2021.04.15)
